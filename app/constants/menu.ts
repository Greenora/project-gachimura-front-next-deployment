...
export const menu: Record<Language, Translation> = {
  ...
  [Language.japanese]: {
    ...
    chat: {
      ...
      settlementWaiting: "割り勘待機中",
      joinSettlement: "割り勘に参加する",
      ...
      systemSettlementStart: "📋 割り勘が始まりました。割り勘ページで購入した品目を選択してください。",
      systemSettlementEditing: "✏️ ホストが品目を見直しています。少しお待ちください。",
      systemSettlementResumed: "✅ 品目の修正が完了しました。割り勘ページで購入した品目を選択してください。",
      systemSettlementConfirmedTitle: "💰 割り勘が確定しました。",
      systemSettlementTotalLabel: "合計金額",
      systemSettlementPerMemberTemplate: "{nickname}: {amount}",
      reviewUnavailable: "この会の終了後に評価できます。",
      reviewAlreadyDone: "この会の評価はすでに完了しています。",
      reviewDone: "評価済み",
      settlementGoTitle: "割り勘ページに移動します",
      settlementWaitTitle: "ホストが割り勘を開始すると利用できます",
      moving: "移動中...",
      closedPartyPlaceholder: "終了した会です。",
      unknownNickname: "不明",
      confirmStartSettlement: "割り勘を開始しますか？",
    ...
    settlement: {
      ...
      totalPrice: "合計金額",
      saveItems: "品目を保存",
      startSettlement: "割り勘を開始する",
      selectItems: "品目を選択",
      selectHint: "自分が持ち帰る品目を選択してください",
      myEstimate: "自分の予想金額",
      submitSelection: "選択完了",
      membersSelecting: "メンバーが選択中...",
      confirmSettlement: "割り勘を確定する",
      confirmMessage: "割り勘を確定しますか？確定後は変更できません。",
      paymentStatus: "入金状況",
      paid: "完了",
      unpaid: "未入金",
      confirmPayment: "入金確認",
      perPerson: "1人当たり",
      kakaoSettle: "カカオトークで割り勘",
      kakaoNotReady: "カカオトーク割り勘機能は準備中です。",
      sentMessage: "割り勘メッセージを送信しました！",
      waitingHost: "ホストが品目を登録しています...",
      waitingItems: "まだ品目がありません。",
      notStarted: "まだ割り勘が開始されていません。",
      settlementWaiting: "割り勘待機中",
      joinSettlement: "割り勘に参加する",
      reportMember: "未払いメンバーを報告する",
      editSettlement: "修正する",
      chatRoom: "チャットへ戻る",
      quantitySuffix: "個",
      memberSuffix: "人",
      ...
      settlementCreated: "割り勘が作成されました。",
      settlementCreateFail: "割り勘の作成に失敗しました。",
      minItemRequired: "少なくとも1つ以上の品目を入力してください。",
      itemsSaved: "品目を保存しました。",
      itemsSaveFail: "品目の保存に失敗しました。",
      settlementStarted: "割り勘を開始しました！メンバーに通知を送信しました。",
      settlementStartFail: "割り勘の開始に失敗しました。",
      revertedToDraft: "品目を修正してください！",
      revertFail: "修正モードへの切り替えに失敗しました。",
      selectionSaved: "品目の選択が完了しました！",
      selectionSaveFail: "選択の保存に失敗しました。",
      confirmPrompt: "割り勘を確定しますか？確定後は変更できません。",
      settlementConfirmed: "割り勘が確定しました！",
      ...
      kakaoShareTitle: "カチムラ割り勘",
      kakaoShareButton: "割り勘を確認する",
      invalidPartyId: "無効な会の番号です。",
    },
  },
};
