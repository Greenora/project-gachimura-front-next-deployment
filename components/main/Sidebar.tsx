        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className={`w-fit px-6 py-2.5 rounded-full text-[13px] font-bold transition-all ${filter === "latest"
            ...
            <button
              ...
              className={`w-fit px-6 py-2.5 rounded-full text-[13px] font-bold transition-all ${filter === "imminent"
                ? "bg-gray-900 text-white shadow-lg shadow-gray-200"
                : "bg-white text-gray-500 border border-gray-100 hover:border-gray-300"
                }`}
            >
